...
In this work, a novel neural network architecture named 'ETER-net' is proposed as a unified solution to reconstruct an MR image directly from k-space data acquired with various k-space trajectories. [paper_link](https://github.com/changheunoh/eternet_fastmri/edit/master/README.md)
